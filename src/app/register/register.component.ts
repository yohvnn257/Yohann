    ...
    template: `
        <div class="min-h-screen flex items-center justify-center overflow-hidden relative">
            ...
            >
                ...
                <h2 class="text-3xl font-bold mb-8 text-center text-gray-800">S'inscrire</h2>
                ...
                <div class="mt-6 text-center">
                    ...
                    <a (click)="navigateToLogin()" class="text-blue-500 hover:text-blue-700 ml-1 font-medium transition-colors cursor-pointer">Se connecter</a>
                </div>
            </div>
        </div>
...
export class RegisterComponent implements OnInit {
    ...
    onRegister(): void {
        ...
        const registerRequest = { email: this.email, password: this.password, direction: this.direction };

        console.log('Envoi de la requête : ', registerRequest); // Debug
